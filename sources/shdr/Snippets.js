...
(function() {
  ...
  Snippets = {
    ...
    'DemoFrag': ['precision highp float;', 'uniform float time;', 'uniform vec2 resolution;', '', 'void main()', '{', '  vec2 pixel = -1.0 + 2.0 * gl_FragCoord.xy / resolution.xy;', '  pixel.x *= resolution.x/resolution.y;', '  gl_FragColor = vec4(pixel,.0,1.);', '}'].join('\n'),
