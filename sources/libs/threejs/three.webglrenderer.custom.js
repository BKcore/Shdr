 ...
 *
 * CUSTOM:
 * 6624: Removed prefixing to ShaderMaterial
 */
...
THREE.WebGLRenderer = function ( parameters ) {
	...
	*/
	...
	function buildProgram ( shaderID, fragmentShader, vertexShader, uniforms, attributes, defines, parameters ) {
		...
		{
				_fs = prefix_fragment + _fs;
				_vs = prefix_vertex + _vs;
		}

		var glFragmentShader = getShader( "fragment", _fs );
		var glVertexShader = getShader( "vertex", _vs );
